...
from edge_sim_py.component_builders.placements_builder import random_fit

# EdgeSimPy component builders
from edge_sim_py.component_builders.map_builder import map_builder
from edge_sim_py.component_builders.edge_server_builder import edge_server_builder
from edge_sim_py.component_builders.network_builder import network_builder
from edge_sim_py.component_builders.container_registry_builder import container_registry_builder
from edge_sim_py.component_builders.user_builder import user_builder
...
edge_server_builder(seed=SEED, number_of_objects=50, capacities=[850, 1700], power_models=[LinearPowerModel])
...
user_builder(
    ...
    number_of_objects=270,
    applications_per_user=[1],
    provisioning_time_slas=[100, 200],
    delay_slas=[25, 50],
